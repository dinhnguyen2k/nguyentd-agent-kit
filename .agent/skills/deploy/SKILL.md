---
name: deploy
description: "Code xong rồi? Đẩy lên Server/Vercel. Use when preparing deployment scripts, configuring CI/CD, or shipping code to production."
---
...
**Execution role**: `deployment role` & `security review role`
...
**Execution role**: `performance-optimizer` & `incident-responder`
