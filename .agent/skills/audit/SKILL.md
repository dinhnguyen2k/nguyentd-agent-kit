---
name: audit
description: "Audit phân tầng ngữ cảnh (Progressive Disclosure) với 5 bước phân cấp rủi ro & kiểm định 4 câu hỏi cốt lõi. Use when preparing for customer delivery, auditing code quality, or checking compliance before release."
---
