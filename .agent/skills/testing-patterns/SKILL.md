...
description: Selects unit, integration, contract, and mocking strategies with meaningful assertions. Use when adding regression coverage or designing a test boundary; not for browser-only E2E work.
metadata:
  category: quality
