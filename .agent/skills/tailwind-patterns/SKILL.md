...
description: Applies Tailwind CSS v4 utilities, tokens, variants, and responsive composition. Use when changing Tailwind architecture or reusable styling patterns; not for isolated class edits.
metadata:
  category: design
