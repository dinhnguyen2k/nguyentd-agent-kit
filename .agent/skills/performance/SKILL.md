---
name: performance
description: "Tối ưu tốc độ và hiệu năng theo chuẩn Performance Expert. Use when diagnosing slow performance, profiling code, or optimizing response times."
---
...
**Execution role**: `performance-optimizer` & `codebase discovery role`
...
**Execution role**: `performance-optimizer`
...
**Execution role**: `frontend-specialist` & `backend-specialist`
